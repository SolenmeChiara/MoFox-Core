...
class APIProvider(ValidatedConfigBase):
    ...
    client_type: Literal["openai", "gemini", "aiohttp_gemini", "bedrock", "anthropic"] = Field(
        default="openai", description="客户端类型（openai/anthropic/aiohttp_gemini/bedrock等，默认为openai）"
    )
